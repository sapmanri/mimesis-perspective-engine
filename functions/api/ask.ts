...
// 실사용 2026-07-22: 이 안내가 과해서 엔진이 스스로 마무리를 해버렸다
// ("짧게 정리해 드릴까요?" → 작별 인사). 그 뒤에 마무리 카드가 또 나와 두 번 끝났다.
// 마무리는 마무리 모드의 일이다. 여기서는 '모으라'까지만 말하고, 끝내지 말라고 못박는다.
const CONVERGE_NOTE =
  "남은 자리가 얼마 없다. 새로운 영역을 열지 말고, 지금까지 나온 것을 모으는 쪽으로 이동을 고른다. " +
  "사용자가 지쳐 있거나 무거운 것을 막 내려놓았다면 머무르는 쪽을 고른다.\n" +
  "다만 이 턴은 여전히 평소의 한 턴이다. 되비춤과 질문 하나로 끝낸다. " +
  "오늘을 요약하지 않고, 요약해 주겠다고 제안하지 않으며, 작별 인사를 하지 않고, " +
  "일어나라고 권하지 않는다. 자리가 끝나간다는 사실 자체를 말하지 않는다. " +
  "마무리는 다른 자리에서 따로 이루어진다.";
